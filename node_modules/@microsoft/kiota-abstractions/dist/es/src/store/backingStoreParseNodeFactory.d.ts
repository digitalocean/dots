...
export declare class BackingStoreParseNodeFactory extends ParseNodeProxyFactory {
    /**
     ...
     */
    constructor(concrete: ParseNodeFactory);
}
//# sourceMappingURL=backingStoreParseNodeFactory.d.ts.map