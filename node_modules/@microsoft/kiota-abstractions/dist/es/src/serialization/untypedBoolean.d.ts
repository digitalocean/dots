 ...
 */
export declare function isUntypedBoolean(node: UntypedNode): node is UntypedBoolean;
/**
 ...
 */
export declare function createUntypedBoolean(value: boolean): UntypedBoolean;
