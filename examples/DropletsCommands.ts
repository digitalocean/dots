...
import { Droplet_action } from "../src/dots/models/index.js";
...
async function listDroplets(tags : object){
...
async function getDropletInfo(dropletId: number) {
...
async function PowerOnDropletByID(dropletId: number){
    console.log(`Powering on the Droplet`);
    try {
        const req: Droplet_action= {
            type : 'power_off'
        }
