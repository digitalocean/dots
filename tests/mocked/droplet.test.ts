							...
							droplets: [
								{
									...
									backupIds: [53893572],
									nextBackupWindow: {
										start: new Date("2019-12-04T00:00:00Z"),
										end: new Date("2019-12-04T23:00:00Z"),
									},
									snapshotIds: [67512819],
									image: {
										id: 7555620,
										...
										public: true,
										regions: ["nyc1", "nyc2"],
										createdAt: new Date("2020-05-04T22:23:02Z"),
										minDiskSize: 20,
										sizeGigabytes: 2.34,
										description: " ",
										tags: ["base-image", "prod"],
        ...
        it('mocks the droplets check status of a droplet with associated resources operation', async () => {
            ...
            const typeExpected = {
							droplet: {
								id: "187000742",
								name: "ubuntu-s-1vcpu-1gb-nyc1-01",
								destroyedAt: new Date("2020-04-01T18:11:49Z"),
							},
							resources: {
								reservedIps: [
									{
										id: "6186916",
										name: "45.55.96.47",
										destroyedAt: new Date("2020-04-01T18:11:44Z"),
									},
								],
								floatingIps: [
									{
							...
							completedAt: new Date("2020-04-01T18:11:49Z"),
							failures: 0,
						};
            const dropletId = 3164444;
