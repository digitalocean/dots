...
import { Registry_create } from "../../src/dots/models/index.js";
import { Registry_run_gc } from "../../src/dots/models/index.js";
import { SubscriptionPostRequestBody } from "../../src/dots/v2/registry/subscription/index.js";
...
describe("Container Registry API", () => {
    ...
    it("should create a container registry", async () => {
        const createReq: Registry_create = {
            name: "example",
    ...
    it("should update subscription", async () => {
        const updateReq :SubscriptionPostRequestBody = { tierSlug: "basic" };
