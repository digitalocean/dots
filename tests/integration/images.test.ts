...
import { Image_new_custom } from "../../src/dots/models/index.js";
import { Image_update } from "../../src/dots/models/index.js";
...
describe("Image Integration Tests", () => {
    it("should create, list, get, update, and delete image", async () => {
        ...
        const imageReq: Image_new_custom = {
            name: expectedName,
    ...
    async function createCustomImage(req: Image_new_custom): Promise<Image> {
