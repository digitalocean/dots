...
import { createDigitalOceanClient, type DigitalOceanClient } from '../../src/dots/digitalOceanClient.js';
import { DigitalOceanApiKeyAuthenticationProvider } from '../../src/dots/DigitalOceanApiKeyAuthenticationProvider.js';
import { FetchRequestAdapter } from '@microsoft/kiota-http-fetchlibrary';
import { Cluster } from '../../src/dots/models/index.js';
...
async function createTestCluster(client: DigitalOceanClient, name: string) {
...
async function waitForClusterRunning(
...
async function deleteCluster(client: DigitalOceanClient, clusterId: string) {
    try {
