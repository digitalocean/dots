...
const CLUSTER_CREATE_BASIC_REQ = {
...
describe("Kubernetes Integration Tests", () => {
    ...
    it("should test kubernetes cluster upgrade", async () => {
        ...
        try {
            ...
            const upgradeReq = { version: nextVersion };
    ...
    async function createKubernetesCluster(req, existingClusterId) {
        ...
        try {
            ...
            if (resp && resp.kubernetesCluster) {
                ...
                await waitForClusterReady(cluster.id);
    ...
    async function waitForClusterReady(clusterId, maxWaitTime = 600000) {
    ...
    function mapToKubernetesCluster(cluster) {
        return {
