 ...
 */
// @ts-ignore
export function serializeVolumesGetResponse(writer, volumesGetResponse = {}, isSerializingDerivedType = false) {
    if (!volumesGetResponse || isSerializingDerivedType) {
        return;
    }
 ...
 */
// @ts-ignore
export function serializeVolumesPostRequestBody(writer, volumesPostRequestBody = {}, isSerializingDerivedType = false) {
 ...
 */
// @ts-ignore
export function serializeVolumesPostResponse(writer, volumesPostResponse = {}, isSerializingDerivedType = false) {
    if (!volumesPostResponse || isSerializingDerivedType) {
        return;
    }
