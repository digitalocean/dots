 ...
 */
// @ts-ignore
export function serializeDomainsGetResponse(writer, domainsGetResponse = {}, isSerializingDerivedType = false) {
    if (!domainsGetResponse || isSerializingDerivedType) {
        return;
    }
 ...
 */
// @ts-ignore
export function serializeDomainsPostResponse(writer, domainsPostResponse = {}, isSerializingDerivedType = false) {
    if (!domainsPostResponse || isSerializingDerivedType) {
        return;
    }
