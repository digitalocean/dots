 ...
 */
// @ts-ignore
export function serializeWithDomain_record_GetResponse(writer, withDomain_record_GetResponse = {}, isSerializingDerivedType = false) {
    if (!withDomain_record_GetResponse || isSerializingDerivedType) {
        return;
    }
 ...
 */
// @ts-ignore
export function serializeWithDomain_record_PatchResponse(writer, withDomain_record_PatchResponse = {}, isSerializingDerivedType = false) {
    if (!withDomain_record_PatchResponse || isSerializingDerivedType) {
        return;
    }
 ...
 */
// @ts-ignore
export function serializeWithDomain_record_PutResponse(writer, withDomain_record_PutResponse = {}, isSerializingDerivedType = false) {
    if (!withDomain_record_PutResponse || isSerializingDerivedType) {
        return;
    }
