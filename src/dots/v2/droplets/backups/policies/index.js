 ...
 */
// @ts-ignore
export function serializePoliciesGetResponse(writer, policiesGetResponse = {}, isSerializingDerivedType = false) {
    if (!policiesGetResponse || isSerializingDerivedType) {
        return;
    }
 ...
 */
// @ts-ignore
export function serializePoliciesGetResponse_policies(writer, policiesGetResponse_policies = {}, isSerializingDerivedType = false) {
    if (!policiesGetResponse_policies || isSerializingDerivedType) {
        return;
    }
