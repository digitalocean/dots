 ...
 */
// @ts-ignore
export function serializeSupported_policiesGetResponse(writer, supported_policiesGetResponse = {}, isSerializingDerivedType = false) {
    if (!supported_policiesGetResponse || isSerializingDerivedType) {
        return;
    }
