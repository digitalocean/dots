 ...
 */
// @ts-ignore
export function serializeWithDroplet_GetResponse(writer, withDroplet_GetResponse = {}, isSerializingDerivedType = false) {
    if (!withDroplet_GetResponse || isSerializingDerivedType) {
        return;
    }
