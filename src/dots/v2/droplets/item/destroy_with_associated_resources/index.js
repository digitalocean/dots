 ...
 */
// @ts-ignore
export function serializeDestroy_with_associated_resourcesGetResponse(writer, destroy_with_associated_resourcesGetResponse = {}, isSerializingDerivedType = false) {
    if (!destroy_with_associated_resourcesGetResponse || isSerializingDerivedType) {
        return;
    }
