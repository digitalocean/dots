 ...
 */
// @ts-ignore
export function serializeAutoscalePostResponse(writer, autoscalePostResponse = {}, isSerializingDerivedType = false) {
    if (!autoscalePostResponse || isSerializingDerivedType) {
        return;
    }
