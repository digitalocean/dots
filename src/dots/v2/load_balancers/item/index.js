 ...
 */
// @ts-ignore
export function serializeWithLb_GetResponse(writer, withLb_GetResponse = {}, isSerializingDerivedType = false) {
    if (!withLb_GetResponse || isSerializingDerivedType) {
        return;
    }
 ...
 */
// @ts-ignore
export function serializeWithLb_PutResponse(writer, withLb_PutResponse = {}, isSerializingDerivedType = false) {
    if (!withLb_PutResponse || isSerializingDerivedType) {
        return;
    }
