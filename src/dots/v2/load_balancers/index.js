 ...
 */
// @ts-ignore
export function serializeLoad_balancersGetResponse(writer, load_balancersGetResponse = {}, isSerializingDerivedType = false) {
    if (!load_balancersGetResponse || isSerializingDerivedType) {
        return;
    }
 ...
 */
// @ts-ignore
export function serializeLoad_balancersPostResponse(writer, load_balancersPostResponse = {}, isSerializingDerivedType = false) {
    if (!load_balancersPostResponse || isSerializingDerivedType) {
        return;
    }
