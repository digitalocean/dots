 ...
 */
// @ts-ignore
export function serializeWithAccess_keyGetResponse(writer, withAccess_keyGetResponse = {}, isSerializingDerivedType = false) {
    if (!withAccess_keyGetResponse || isSerializingDerivedType) {
        return;
    }
 ...
 */
// @ts-ignore
export function serializeWithAccess_keyPatchResponse(writer, withAccess_keyPatchResponse = {}, isSerializingDerivedType = false) {
    if (!withAccess_keyPatchResponse || isSerializingDerivedType) {
        return;
    }
 ...
 */
// @ts-ignore
export function serializeWithAccess_keyPutResponse(writer, withAccess_keyPutResponse = {}, isSerializingDerivedType = false) {
    if (!withAccess_keyPutResponse || isSerializingDerivedType) {
        return;
    }
