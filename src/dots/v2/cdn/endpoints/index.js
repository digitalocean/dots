 ...
 */
// @ts-ignore
export function serializeEndpointsGetResponse(writer, endpointsGetResponse = {}, isSerializingDerivedType = false) {
    if (!endpointsGetResponse || isSerializingDerivedType) {
        return;
    }
 ...
 */
// @ts-ignore
export function serializeEndpointsPostResponse(writer, endpointsPostResponse = {}, isSerializingDerivedType = false) {
    if (!endpointsPostResponse || isSerializingDerivedType) {
        return;
    }
