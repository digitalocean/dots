 ...
 */
// @ts-ignore
export function serializeWithCdn_GetResponse(writer, withCdn_GetResponse = {}, isSerializingDerivedType = false) {
    if (!withCdn_GetResponse || isSerializingDerivedType) {
        return;
    }
 ...
 */
// @ts-ignore
export function serializeWithCdn_PutResponse(writer, withCdn_PutResponse = {}, isSerializingDerivedType = false) {
    if (!withCdn_PutResponse || isSerializingDerivedType) {
        return;
    }
