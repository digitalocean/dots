...
// @ts-ignore
import { createDatabase_backupFromDiscriminatorValue, createDatabase_cluster_readFromDiscriminatorValue, createErrorEscapedFromDiscriminatorValue, deserializeIntoDatabase_cluster, serializeDatabase_backup, serializeDatabase_cluster, serializeDatabase_cluster_read } from '../../models/index.js';
// @ts-ignore
...
export function deserializeIntoDatabasesGetResponse(databasesGetResponse = {}) {
    return {
        "databases": n => { databasesGetResponse.databases = n.getCollectionOfObjectValues(createDatabase_cluster_readFromDiscriminatorValue); },
    };
}
/**
 * The deserialization information for the current model
...
export function deserializeIntoDatabasesPostResponse(databasesPostResponse = {}) {
    return {
        "database": n => { databasesPostResponse.database = n.getObjectValue(createDatabase_cluster_readFromDiscriminatorValue); },
    };
}
/**
 ...
 */
// @ts-ignore
export function serializeDatabasesGetResponse(writer, databasesGetResponse = {}, isSerializingDerivedType = false) {
    if (!databasesGetResponse || isSerializingDerivedType) {
        return;
    }
    writer.writeCollectionOfObjectValues("databases", databasesGetResponse.databases, serializeDatabase_cluster_read);
 ...
 */
// @ts-ignore
export function serializeDatabasesPostRequestBody(writer, databasesPostRequestBody = {}, isSerializingDerivedType = false) {
    if (!databasesPostRequestBody || isSerializingDerivedType) {
        return;
    }
 ...
 */
// @ts-ignore
export function serializeDatabasesPostResponse(writer, databasesPostResponse = {}, isSerializingDerivedType = false) {
    if (!databasesPostResponse || isSerializingDerivedType) {
        return;
    }
    writer.writeObjectValue("database", databasesPostResponse.database, serializeDatabase_cluster_read);
