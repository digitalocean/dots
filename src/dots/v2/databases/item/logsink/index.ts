...
// @ts-ignore
import { createErrorEscapedFromDiscriminatorValue, createLogsink_schemaFromDiscriminatorValue, serializeLogsink_create, serializeLogsink_schema, type ErrorEscaped, type Logsink_create, type Logsink_schema } from '../../../../models/index.js';
// @ts-ignore
...
export function deserializeIntoLogsinkGetResponse(logsinkGetResponse: Partial<LogsinkGetResponse> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        "sinks": n => { logsinkGetResponse.sinks = n.getCollectionOfObjectValues<Logsink_schema>(createLogsink_schemaFromDiscriminatorValue); },
    }
}
/**
 * The deserialization information for the current model
...
export function deserializeIntoLogsinkPostResponse(logsinkPostResponse: Partial<LogsinkPostResponse> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        "sink": n => { logsinkPostResponse.sink = n.getObjectValue<Logsink_schema>(createLogsink_schemaFromDiscriminatorValue); },
    }
}
...
export function serializeLogsinkGetResponse(writer: SerializationWriter, logsinkGetResponse: Partial<LogsinkGetResponse> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    ...
    writer.writeCollectionOfObjectValues<Logsink_schema>("sinks", logsinkGetResponse.sinks, serializeLogsink_schema);
...
export function serializeLogsinkPostResponse(writer: SerializationWriter, logsinkPostResponse: Partial<LogsinkPostResponse> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    ...
    writer.writeObjectValue<Logsink_schema>("sink", logsinkPostResponse.sink, serializeLogsink_schema);
