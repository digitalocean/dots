...
// @ts-ignore
import { createErrorEscapedFromDiscriminatorValue, createLogsink_schemaFromDiscriminatorValue, serializeLogsink_create, serializeLogsink_schema } from '../../../../models/index.js';
// @ts-ignore
...
export function deserializeIntoLogsinkGetResponse(logsinkGetResponse = {}) {
    return {
        "sinks": n => { logsinkGetResponse.sinks = n.getCollectionOfObjectValues(createLogsink_schemaFromDiscriminatorValue); },
    };
}
/**
 * The deserialization information for the current model
...
export function deserializeIntoLogsinkPostResponse(logsinkPostResponse = {}) {
    return {
        "sink": n => { logsinkPostResponse.sink = n.getObjectValue(createLogsink_schemaFromDiscriminatorValue); },
    };
}
/**
...
export function serializeLogsinkGetResponse(writer, logsinkGetResponse = {}, isSerializingDerivedType = false) {
    ...
    writer.writeCollectionOfObjectValues("sinks", logsinkGetResponse.sinks, serializeLogsink_schema);
...
export function serializeLogsinkPostResponse(writer, logsinkPostResponse = {}, isSerializingDerivedType = false) {
    ...
    writer.writeObjectValue("sink", logsinkPostResponse.sink, serializeLogsink_schema);
