 ...
 */
// @ts-ignore
export function serializeWithLogsink_GetResponse(writer, withLogsink_GetResponse = {}, isSerializingDerivedType = false) {
    if (!withLogsink_GetResponse || isSerializingDerivedType) {
        return;
    }
