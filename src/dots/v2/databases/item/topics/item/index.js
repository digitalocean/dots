 ...
 */
// @ts-ignore
export function serializeWithTopic_nameGetResponse(writer, withTopic_nameGetResponse = {}, isSerializingDerivedType = false) {
    if (!withTopic_nameGetResponse || isSerializingDerivedType) {
        return;
    }
 ...
 */
// @ts-ignore
export function serializeWithTopic_namePutResponse(writer, withTopic_namePutResponse = {}, isSerializingDerivedType = false) {
    if (!withTopic_namePutResponse || isSerializingDerivedType) {
        return;
    }
