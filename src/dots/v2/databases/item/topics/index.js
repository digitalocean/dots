 ...
 */
// @ts-ignore
export function serializeTopicsGetResponse(writer, topicsGetResponse = {}, isSerializingDerivedType = false) {
    if (!topicsGetResponse || isSerializingDerivedType) {
        return;
    }
 ...
 */
// @ts-ignore
export function serializeTopicsPostResponse(writer, topicsPostResponse = {}, isSerializingDerivedType = false) {
    if (!topicsPostResponse || isSerializingDerivedType) {
        return;
    }
