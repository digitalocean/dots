 ...
 */
// @ts-ignore
export function serializeUsersGetResponse(writer, usersGetResponse = {}, isSerializingDerivedType = false) {
    if (!usersGetResponse || isSerializingDerivedType) {
        return;
    }
 ...
 */
// @ts-ignore
export function serializeUsersPostRequestBody(writer, usersPostRequestBody = {}, isSerializingDerivedType = false) {
    if (!usersPostRequestBody || isSerializingDerivedType) {
        return;
    }
 ...
 */
// @ts-ignore
export function serializeUsersPostResponse(writer, usersPostResponse = {}, isSerializingDerivedType = false) {
    if (!usersPostResponse || isSerializingDerivedType) {
        return;
    }
