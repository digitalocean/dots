 ...
 */
// @ts-ignore
export function serializeReset_authPostRequestBody(writer, reset_authPostRequestBody = {}, isSerializingDerivedType = false) {
    if (!reset_authPostRequestBody || isSerializingDerivedType) {
        return;
    }
 ...
 */
// @ts-ignore
export function serializeReset_authPostResponse(writer, reset_authPostResponse = {}, isSerializingDerivedType = false) {
    if (!reset_authPostResponse || isSerializingDerivedType) {
        return;
    }
