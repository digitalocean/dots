...
// @ts-ignore
import { createDatabase_clusterFromDiscriminatorValue, createErrorEscapedFromDiscriminatorValue, serializeDatabase_cluster } from '../../../models/index.js';
// @ts-ignore
...
export function deserializeIntoWithDatabase_cluster_uuGetResponse(withDatabase_cluster_uuGetResponse = {}) {
    return {
        "database": n => { withDatabase_cluster_uuGetResponse.database = n.getObjectValue(createDatabase_clusterFromDiscriminatorValue); },
    };
}
/**
