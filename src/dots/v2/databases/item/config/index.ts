...
export type ConfigGetResponse_config = Kafka_advanced_config | Mongo_advanced_config | Mysql_advanced_config | Opensearch_advanced_config | Postgres_advanced_config | Redis_advanced_config;
/**
 ...
 */
// @ts-ignore
export function deserializeIntoConfigGetResponse_config(configGetResponse_config: Partial<Kafka_advanced_config | Mongo_advanced_config | Mysql_advanced_config | Opensearch_advanced_config | Postgres_advanced_config | Redis_advanced_config> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
...
export function serializeConfigGetResponse(writer: SerializationWriter, configGetResponse: Partial<ConfigGetResponse> | undefined | null = {}) : void {
    if (configGetResponse) {
        writer.writeObjectValue<Kafka_advanced_config | Mongo_advanced_config | Mysql_advanced_config | Opensearch_advanced_config | Postgres_advanced_config | Redis_advanced_config>("config", configGetResponse.config, serializeConfigGetResponse_config);
 ...
 */
// @ts-ignore
export function serializeConfigGetResponse_config(writer: SerializationWriter, configGetResponse_config: Partial<Kafka_advanced_config | Mongo_advanced_config | Mysql_advanced_config | Opensearch_advanced_config | Postgres_advanced_config | Redis_advanced_config> | undefined | null = {}) : void {
