...
// @ts-ignore
import { ConfigRequestBuilderNavigationMetadata, ConfigRequestBuilderRequestsMetadata } from './config/index.js';
// @ts-ignore
 ...
 */
// @ts-ignore
export function serializeSchemaRegistryGetResponse(writer, schemaRegistryGetResponse = {}, isSerializingDerivedType = false) {
    if (!schemaRegistryGetResponse || isSerializingDerivedType) {
        return;
    }
