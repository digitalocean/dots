...
export function deserializeIntoReplicasGetResponse(replicasGetResponse = {}) {
    return {
        "replicas": n => { replicasGetResponse.replicas = n.getCollectionOfObjectValues(createDatabase_replicaFromDiscriminatorValue); },
    };
}
/**
 * The deserialization information for the current model
...
export function deserializeIntoReplicasPostResponse(replicasPostResponse = {}) {
    return {
        "replica": n => { replicasPostResponse.replica = n.getObjectValue(createDatabase_replicaFromDiscriminatorValue); },
    };
}
/**
