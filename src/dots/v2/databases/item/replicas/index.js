 ...
 */
// @ts-ignore
export function serializeReplicasGetResponse(writer, replicasGetResponse = {}, isSerializingDerivedType = false) {
    if (!replicasGetResponse || isSerializingDerivedType) {
        return;
    }
 ...
 */
// @ts-ignore
export function serializeReplicasPostResponse(writer, replicasPostResponse = {}, isSerializingDerivedType = false) {
    if (!replicasPostResponse || isSerializingDerivedType) {
        return;
    }
