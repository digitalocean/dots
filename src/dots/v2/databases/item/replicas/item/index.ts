...
// @ts-ignore
import { createDatabase_replica_readFromDiscriminatorValue, createErrorEscapedFromDiscriminatorValue, serializeDatabase_replica_read, type Database_replica_read, type ErrorEscaped } from '../../../../../models/index.js';
// @ts-ignore
...
export function deserializeIntoWithReplica_nameGetResponse(withReplica_nameGetResponse: Partial<WithReplica_nameGetResponse> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        "replica": n => { withReplica_nameGetResponse.replica = n.getObjectValue<Database_replica_read>(createDatabase_replica_readFromDiscriminatorValue); },
    }
}
/**
