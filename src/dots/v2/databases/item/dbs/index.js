 ...
 */
// @ts-ignore
export function serializeDbsGetResponse(writer, dbsGetResponse = {}, isSerializingDerivedType = false) {
    if (!dbsGetResponse || isSerializingDerivedType) {
        return;
    }
 ...
 */
// @ts-ignore
export function serializeDbsPostResponse(writer, dbsPostResponse = {}, isSerializingDerivedType = false) {
    if (!dbsPostResponse || isSerializingDerivedType) {
        return;
    }
