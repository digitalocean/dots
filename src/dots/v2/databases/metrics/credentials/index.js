 ...
 */
// @ts-ignore
export function serializeCredentialsGetResponse(writer, credentialsGetResponse = {}, isSerializingDerivedType = false) {
    if (!credentialsGetResponse || isSerializingDerivedType) {
        return;
    }
