 ...
 */
// @ts-ignore
export function serializePeeringsGetResponse(writer, peeringsGetResponse = {}, isSerializingDerivedType = false) {
    if (!peeringsGetResponse || isSerializingDerivedType) {
        return;
    }
 ...
 */
// @ts-ignore
export function serializePeeringsPostRequestBody(writer, peeringsPostRequestBody = {}, isSerializingDerivedType = false) {
    if (!peeringsPostRequestBody || isSerializingDerivedType) {
        return;
    }
 ...
 */
// @ts-ignore
export function serializePeeringsPostResponse(writer, peeringsPostResponse = {}, isSerializingDerivedType = false) {
    if (!peeringsPostResponse || isSerializingDerivedType) {
        return;
    }
