 ...
 */
// @ts-ignore
export function serializeVpcsGetResponse(writer, vpcsGetResponse = {}, isSerializingDerivedType = false) {
    if (!vpcsGetResponse || isSerializingDerivedType) {
        return;
    }
 ...
 */
// @ts-ignore
export function serializeVpcsPostRequestBody(writer, vpcsPostRequestBody = {}, isSerializingDerivedType = false) {
    if (!vpcsPostRequestBody || isSerializingDerivedType) {
        return;
    }
 ...
 */
// @ts-ignore
export function serializeVpcsPostResponse(writer, vpcsPostResponse = {}, isSerializingDerivedType = false) {
    if (!vpcsPostResponse || isSerializingDerivedType) {
        return;
    }
