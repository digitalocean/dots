 ...
 */
// @ts-ignore
export function serializeWithFirewall_GetResponse(writer, withFirewall_GetResponse = {}, isSerializingDerivedType = false) {
    if (!withFirewall_GetResponse || isSerializingDerivedType) {
        return;
    }
 ...
 */
// @ts-ignore
export function serializeWithFirewall_PutResponse(writer, withFirewall_PutResponse = {}, isSerializingDerivedType = false) {
    if (!withFirewall_PutResponse || isSerializingDerivedType) {
        return;
    }
