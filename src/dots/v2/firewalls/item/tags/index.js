 ...
 */
// @ts-ignore
export function serializeTagsDeleteRequestBody(writer, tagsDeleteRequestBody = {}, isSerializingDerivedType = false) {
    if (!tagsDeleteRequestBody || isSerializingDerivedType) {
        return;
    }
 ...
 */
// @ts-ignore
export function serializeTagsPostRequestBody(writer, tagsPostRequestBody = {}, isSerializingDerivedType = false) {
    if (!tagsPostRequestBody || isSerializingDerivedType) {
        return;
    }
