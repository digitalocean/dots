 ...
 */
// @ts-ignore
export function serializeFirewallsGetResponse(writer, firewallsGetResponse = {}, isSerializingDerivedType = false) {
    if (!firewallsGetResponse || isSerializingDerivedType) {
        return;
    }
 ...
 */
// @ts-ignore
export function serializeFirewallsPostResponse(writer, firewallsPostResponse = {}, isSerializingDerivedType = false) {
    if (!firewallsPostResponse || isSerializingDerivedType) {
        return;
    }
