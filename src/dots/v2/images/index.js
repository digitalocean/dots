 ...
 */
// @ts-ignore
export function serializeImagesGetResponse(writer, imagesGetResponse = {}, isSerializingDerivedType = false) {
    if (!imagesGetResponse || isSerializingDerivedType) {
        return;
    }
 ...
 */
// @ts-ignore
export function serializeImagesPostResponse(writer, imagesPostResponse = {}, isSerializingDerivedType = false) {
    if (!imagesPostResponse || isSerializingDerivedType) {
        return;
    }
