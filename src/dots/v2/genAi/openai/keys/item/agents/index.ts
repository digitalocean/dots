...
// @ts-ignore
import { createApiListAgentsByOpenAIKeyOutputFromDiscriminatorValue, createErrorEscapedFromDiscriminatorValue, type ApiListAgentsByOpenAIKeyOutput, type ErrorEscaped } from '../../../../../../models/index.js';
// @ts-ignore
...
export interface AgentsRequestBuilder extends BaseRequestBuilder<AgentsRequestBuilder> {
     ...
     * @returns {Promise<ApiListAgentsByOpenAIKeyOutput>}
     ...
     */
     get(requestConfiguration?: RequestConfiguration<AgentsRequestBuilderGetQueryParameters> | undefined) : Promise<ApiListAgentsByOpenAIKeyOutput | undefined>;
    /**
     * List Agents by OpenAI Key.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const AgentsRequestBuilderUriTemplate = "{+baseurl}/v2/gen-ai/openai/keys/{api_key_uu%2Did}/agents{?page*,per_page*}";
/**
...
export const AgentsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        ...
        responseBodyFactory:  createApiListAgentsByOpenAIKeyOutputFromDiscriminatorValue,
