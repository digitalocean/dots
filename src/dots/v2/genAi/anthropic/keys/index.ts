...
// @ts-ignore
import { createApiCreateAnthropicAPIKeyOutputFromDiscriminatorValue, createApiListAnthropicAPIKeysOutputFromDiscriminatorValue, createErrorEscapedFromDiscriminatorValue, serializeApiCreateAnthropicAPIKeyInputPublic, serializeApiCreateAnthropicAPIKeyOutput, type ApiCreateAnthropicAPIKeyInputPublic, type ApiCreateAnthropicAPIKeyOutput, type ApiListAnthropicAPIKeysOutput, type ErrorEscaped } from '../../../../models/index.js';
// @ts-ignore
...
export interface KeysRequestBuilder extends BaseRequestBuilder<KeysRequestBuilder> {
     ...
     * @returns {Promise<ApiListAnthropicAPIKeysOutput>}
     ...
     */
     get(requestConfiguration?: RequestConfiguration<KeysRequestBuilderGetQueryParameters> | undefined) : Promise<ApiListAnthropicAPIKeysOutput | undefined>;
    /**
     * To create an Anthropic API key, send a POST request to `/v2/gen-ai/anthropic/keys`.
     * @param body CreateAnthropicAPIKeyInputPublic is used to create a new Anthropic API key for a specific agent.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @returns {Promise<ApiCreateAnthropicAPIKeyOutput>}
     * @throws {ErrorEscaped} error when the service returns a 401 status code
     * @throws {ErrorEscaped} error when the service returns a 404 status code
     * @throws {ErrorEscaped} error when the service returns a 429 status code
     * @throws {ErrorEscaped} error when the service returns a 500 status code
     * @throws {ErrorEscaped} error when the service returns a 4XX or 5XX status code
     */
     post(body: ApiCreateAnthropicAPIKeyInputPublic, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<ApiCreateAnthropicAPIKeyOutput | undefined>;
    /**
     * To list all Anthropic API keys, send a GET request to `/v2/gen-ai/anthropic/keys`.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     ...
     * @returns {RequestInformation}
     */
     toPostRequestInformation(body: ApiCreateAnthropicAPIKeyInputPublic, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation;
}
/**
 * To list all Anthropic API keys, send a GET request to `/v2/gen-ai/anthropic/keys`.
 */
