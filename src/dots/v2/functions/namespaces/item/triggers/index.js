 ...
 */
// @ts-ignore
export function serializeTriggersGetResponse(writer, triggersGetResponse = {}, isSerializingDerivedType = false) {
    if (!triggersGetResponse || isSerializingDerivedType) {
        return;
    }
 ...
 */
// @ts-ignore
export function serializeTriggersPostResponse(writer, triggersPostResponse = {}, isSerializingDerivedType = false) {
    if (!triggersPostResponse || isSerializingDerivedType) {
        return;
    }
