 ...
 */
// @ts-ignore
export function serializeWithNamespace_GetResponse(writer, withNamespace_GetResponse = {}, isSerializingDerivedType = false) {
    if (!withNamespace_GetResponse || isSerializingDerivedType) {
        return;
    }
