 ...
 */
// @ts-ignore
export function serializeNamespacesGetResponse(writer, namespacesGetResponse = {}, isSerializingDerivedType = false) {
    if (!namespacesGetResponse || isSerializingDerivedType) {
        return;
    }
 ...
 */
// @ts-ignore
export function serializeNamespacesPostResponse(writer, namespacesPostResponse = {}, isSerializingDerivedType = false) {
    if (!namespacesPostResponse || isSerializingDerivedType) {
        return;
    }
