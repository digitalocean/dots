...
export interface UsersRequestBuilder extends BaseRequestBuilder<UsersRequestBuilder> {
    /**
     * Gets an item from the ApiSdk.v2.actionGateway.users.item collection
 ...
 */
export const UsersRequestBuilderUriTemplate = "{+baseurl}/v2/action-gateway/users{?page*,per_page*}";
/**
