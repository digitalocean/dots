...
export type ActionsPostRequestBody = Nfs_action_attach | Nfs_action_detach | Nfs_action_resize | Nfs_action_snapshot;
/**
...
export interface ActionsRequestBuilder extends BaseRequestBuilder<ActionsRequestBuilder> {
     ...
     */
     post(body: Nfs_action_attach | Nfs_action_detach | Nfs_action_resize | Nfs_action_snapshot, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<Nfs_actions_response | undefined>;
    /**
     * To execute an action (such as resize) on a specified NFS share, send a POST request to `/v2/nfs/{nfs_id}/actions`. In the JSON body to the request, set the `type` attribute to on of the supported action types:| Action                           | Details || -------------------------------- | ----------- || <nobr>`resize`</nobr>            | Resizes an NFS share. Set the size_gib attribute to a desired value in GiB || <nobr>`snapshot`</nobr>          | Takes a snapshot of an NFS share || <nobr>`attach`</nobr>            | Attaches an NFS share to a VPC. Set the vpc_id attribute to the desired VPC ID || <nobr>`detach`</nobr>            | Detaches an NFS share from a VPC. Set the vpc_id attribute to the desired VPC ID |
     * @param body The request body
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     ...
     */
     toPostRequestInformation(body: Nfs_action_attach | Nfs_action_detach | Nfs_action_resize | Nfs_action_snapshot, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation;
}
/**
 ...
 */
// @ts-ignore
export function deserializeIntoActionsPostRequestBody(actionsPostRequestBody: Partial<Nfs_action_attach | Nfs_action_detach | Nfs_action_resize | Nfs_action_snapshot> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
 ...
 */
// @ts-ignore
export function serializeActionsPostRequestBody(writer: SerializationWriter, actionsPostRequestBody: Partial<Nfs_action_attach | Nfs_action_detach | Nfs_action_resize | Nfs_action_snapshot> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
