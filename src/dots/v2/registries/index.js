 ...
 */
// @ts-ignore
export function serializeRegistriesGetResponse(writer, registriesGetResponse = {}) {
 ...
 */
// @ts-ignore
export function serializeRegistriesPostResponse(writer, registriesPostResponse = {}) {
