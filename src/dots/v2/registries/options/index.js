 ...
 */
// @ts-ignore
export function serializeOptionsGetResponse(writer, optionsGetResponse = {}, isSerializingDerivedType = false) {
    if (!optionsGetResponse || isSerializingDerivedType) {
        return;
    }
 ...
 */
// @ts-ignore
export function serializeOptionsGetResponse_options(writer, optionsGetResponse_options = {}, isSerializingDerivedType = false) {
    if (!optionsGetResponse_options || isSerializingDerivedType) {
        return;
    }
 ...
 */
// @ts-ignore
export function serializeOptionsGetResponse_options_subscription_tiers(writer, optionsGetResponse_options_subscription_tiers = {}, isSerializingDerivedType = false) {
    if (!optionsGetResponse_options_subscription_tiers || isSerializingDerivedType) {
        return;
    }
