 ...
 */
// @ts-ignore
export function serializeWithRegistry_nameGetResponse(writer, withRegistry_nameGetResponse = {}, isSerializingDerivedType = false) {
    if (!withRegistry_nameGetResponse || isSerializingDerivedType) {
        return;
    }
