 ...
 */
// @ts-ignore
export function serializeDigestsGetResponse(writer, digestsGetResponse = {}, isSerializingDerivedType = false) {
    if (!digestsGetResponse || isSerializingDerivedType) {
        return;
    }
 ...
 */
export const DigestsRequestBuilderUriTemplate = "{+baseurl}/v2/registries/{registry_name}/repositories/{repository_name}/digests{?page*,per_page*}";
/**
