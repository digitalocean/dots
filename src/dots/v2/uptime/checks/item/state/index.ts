 ...
 */
// @ts-ignore
export function serializeStateGetResponse(writer: SerializationWriter, stateGetResponse: Partial<StateGetResponse> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!stateGetResponse || isSerializingDerivedType) { return; }
