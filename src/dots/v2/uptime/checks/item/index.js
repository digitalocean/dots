 ...
 */
// @ts-ignore
export function serializeWithCheck_GetResponse(writer, withCheck_GetResponse = {}, isSerializingDerivedType = false) {
    if (!withCheck_GetResponse || isSerializingDerivedType) {
        return;
    }
 ...
 */
// @ts-ignore
export function serializeWithCheck_PutRequestBody(writer, withCheck_PutRequestBody = {}, isSerializingDerivedType = false) {
    if (!withCheck_PutRequestBody || isSerializingDerivedType) {
        return;
    }
 ...
 */
// @ts-ignore
export function serializeWithCheck_PutResponse(writer, withCheck_PutResponse = {}, isSerializingDerivedType = false) {
    if (!withCheck_PutResponse || isSerializingDerivedType) {
        return;
    }
