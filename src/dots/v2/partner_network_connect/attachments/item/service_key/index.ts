...
export interface Service_keyGetResponse extends Parsable {
    /**
     * The service_key property
     */
    serviceKey?: Service_keyGetResponse_service_key | null;
}
export interface Service_keyGetResponse_service_key extends Parsable {
}
export interface Service_keyPostResponse extends Parsable {
}
/**
