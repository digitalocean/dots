 ...
 */
// @ts-ignore
export function serializeAttachmentsGetResponse(writer, attachmentsGetResponse = {}, isSerializingDerivedType = false) {
    if (!attachmentsGetResponse || isSerializingDerivedType) {
        return;
    }
 ...
 */
// @ts-ignore
export function serializeAttachmentsPostResponse(writer, attachmentsPostResponse = {}, isSerializingDerivedType = false) {
    if (!attachmentsPostResponse || isSerializingDerivedType) {
        return;
    }
