...
export function deserializeIntoClustersGetResponse(clustersGetResponse: Partial<ClustersGetResponse> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        "kubernetes_clusters": n => { clustersGetResponse.kubernetesClusters = n.getCollectionOfObjectValues<Cluster_read>(createCluster_readFromDiscriminatorValue); },
