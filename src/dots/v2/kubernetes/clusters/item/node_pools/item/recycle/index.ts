 ...
 * @param RecyclePostRequestBody The instance to deserialize into.
 ...
 * @param RecyclePostRequestBody The instance to serialize from.
 * @param writer Serialization writer to use to serialize this model
 */
// @ts-ignore
export function serializeRecyclePostRequestBody(writer: SerializationWriter, recyclePostRequestBody: Partial<RecyclePostRequestBody> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!recyclePostRequestBody || isSerializingDerivedType) { return; }
