 ...
 */
// @ts-ignore
export function serializeRecyclePostRequestBody(writer, recyclePostRequestBody = {}, isSerializingDerivedType = false) {
    if (!recyclePostRequestBody || isSerializingDerivedType) {
        return;
    }
