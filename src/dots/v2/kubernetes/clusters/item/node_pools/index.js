 ...
 */
// @ts-ignore
export function serializeNode_poolsGetResponse(writer, node_poolsGetResponse = {}, isSerializingDerivedType = false) {
    if (!node_poolsGetResponse || isSerializingDerivedType) {
        return;
    }
 ...
 */
// @ts-ignore
export function serializeNode_poolsPostResponse(writer, node_poolsPostResponse = {}, isSerializingDerivedType = false) {
    if (!node_poolsPostResponse || isSerializingDerivedType) {
        return;
    }
