...
// @ts-ignore
import { createClusterFromDiscriminatorValue, createErrorEscapedFromDiscriminatorValue, serializeCluster, serializeCluster_update } from '../../../../models/index.js';
// @ts-ignore
...
export function deserializeIntoWithCluster_GetResponse(withCluster_GetResponse = {}) {
    return {
        "kubernetes_cluster": n => { withCluster_GetResponse.kubernetesCluster = n.getObjectValue(createClusterFromDiscriminatorValue); },
    };
}
/**
 * The deserialization information for the current model
