 ...
 */
// @ts-ignore
export function serializeWithCluster_GetResponse(writer, withCluster_GetResponse = {}, isSerializingDerivedType = false) {
    if (!withCluster_GetResponse || isSerializingDerivedType) {
        return;
    }
 ...
 */
// @ts-ignore
export function serializeWithCluster_PutResponse(writer, withCluster_PutResponse = {}, isSerializingDerivedType = false) {
    if (!withCluster_PutResponse || isSerializingDerivedType) {
        return;
    }
