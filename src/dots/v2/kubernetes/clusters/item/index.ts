...
// @ts-ignore
import { createClusterFromDiscriminatorValue, createErrorEscapedFromDiscriminatorValue, serializeCluster, serializeCluster_update, type Cluster, type Cluster_update, type ErrorEscaped } from '../../../../models/index.js';
// @ts-ignore
...
export function deserializeIntoWithCluster_GetResponse(withCluster_GetResponse: Partial<WithCluster_GetResponse> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        "kubernetes_cluster": n => { withCluster_GetResponse.kubernetesCluster = n.getObjectValue<Cluster>(createClusterFromDiscriminatorValue); },
    }
}
/**
 * The deserialization information for the current model
