...
// @ts-ignore
import { createErrorEscapedFromDiscriminatorValue, createVpc_nat_gateway_getFromDiscriminatorValue, createVpc_nat_gateway_updateFromDiscriminatorValue, serializeVpc_nat_gateway_get, serializeVpc_nat_gateway_update, type ErrorEscaped, type Vpc_nat_gateway_get, type Vpc_nat_gateway_update } from '../../../models/index.js';
// @ts-ignore
...
export function deserializeIntoVpc_nat_gatewaysPutResponse(vpc_nat_gatewaysPutResponse: Partial<Vpc_nat_gatewaysPutResponse> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        "vpc_nat_gateway": n => { vpc_nat_gatewaysPutResponse.vpcNatGateway = n.getObjectValue<Vpc_nat_gateway_update>(createVpc_nat_gateway_updateFromDiscriminatorValue); },
    }
}
/**
...
export function serializeVpc_nat_gatewaysPutResponse(writer: SerializationWriter, vpc_nat_gatewaysPutResponse: Partial<Vpc_nat_gatewaysPutResponse> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    ...
    writer.writeObjectValue<Vpc_nat_gateway_update>("vpc_nat_gateway", vpc_nat_gatewaysPutResponse.vpcNatGateway, serializeVpc_nat_gateway_update);
...
export interface Vpc_nat_gatewaysPutResponse extends AdditionalDataHolder, Parsable {
     ...
     * The vpc_nat_gateway property
     */
    vpcNatGateway?: Vpc_nat_gateway_update | null;
}
/**
