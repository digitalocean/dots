 ...
 * @param SizesGetResponse The instance to deserialize into.
 ...
 * @param SizesGetResponse The instance to serialize from.
 * @param writer Serialization writer to use to serialize this model
 */
// @ts-ignore
export function serializeSizesGetResponse(writer: SerializationWriter, sizesGetResponse: Partial<SizesGetResponse> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    if (!sizesGetResponse || isSerializingDerivedType) { return; }
