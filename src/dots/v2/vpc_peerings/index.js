 ...
 */
// @ts-ignore
export function serializeVpc_peeringsGetResponse(writer, vpc_peeringsGetResponse = {}, isSerializingDerivedType = false) {
    if (!vpc_peeringsGetResponse || isSerializingDerivedType) {
        return;
    }
 ...
 */
// @ts-ignore
export function serializeVpc_peeringsPostRequestBody(writer, vpc_peeringsPostRequestBody = {}, isSerializingDerivedType = false) {
    if (!vpc_peeringsPostRequestBody || isSerializingDerivedType) {
        return;
    }
 ...
 */
// @ts-ignore
export function serializeVpc_peeringsPostResponse(writer, vpc_peeringsPostResponse = {}, isSerializingDerivedType = false) {
    if (!vpc_peeringsPostResponse || isSerializingDerivedType) {
        return;
    }
