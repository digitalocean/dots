...
/**
 * Builds and executes requests for operations under /v2/registry/{registry_name}/garbage-collections
 */
 ...
 */
export const GarbageCollectionsRequestBuilderUriTemplate = "{+baseurl}/v2/registry/{registry_name}/garbage-collections{?page*,per_page*}";
/**
