 ...
 */
// @ts-ignore
export function serializeTagsGetResponse(writer, tagsGetResponse = {}, isSerializingDerivedType = false) {
    if (!tagsGetResponse || isSerializingDerivedType) {
        return;
    }
 ...
 */
export const TagsRequestBuilderUriTemplate = "{+baseurl}/v2/registry/{registry_name}/repositories/{repository_name}/tags{?page*,per_page*}";
/**
