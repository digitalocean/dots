...
export interface GarbageCollectionGetResponse extends Parsable {
    /**
     * The garbage_collection property
     */
    garbageCollection?: Garbage_collection | null;
}
export interface GarbageCollectionPostResponse extends Parsable {
    /**
     * The garbage_collection property
     */
    garbageCollection?: Garbage_collection | null;
...
export interface GarbageCollectionRequestBuilder extends BaseRequestBuilder<GarbageCollectionRequestBuilder> {
    /**
     * Gets an item from the dots.v2.registry.item.garbageCollection.item collection
