...
// @ts-ignore
import { createErrorEscapedFromDiscriminatorValue, createGarbage_collectionFromDiscriminatorValue, serializeGarbage_collection, serializeRegistry_run_gc } from '../../../../models/index.js';
// @ts-ignore
 ...
 */
// @ts-ignore
export function serializeGarbageCollectionGetResponse(writer, garbageCollectionGetResponse = {}, isSerializingDerivedType = false) {
    if (!garbageCollectionGetResponse || isSerializingDerivedType) {
        return;
    }
 ...
 */
// @ts-ignore
export function serializeGarbageCollectionPostResponse(writer, garbageCollectionPostResponse = {}, isSerializingDerivedType = false) {
    if (!garbageCollectionPostResponse || isSerializingDerivedType) {
        return;
    }
