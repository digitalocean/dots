 ...
 */
// @ts-ignore
export function serializeRegistryGetResponse(writer, registryGetResponse = {}, isSerializingDerivedType = false) {
    if (!registryGetResponse || isSerializingDerivedType) {
        return;
    }
 ...
 */
// @ts-ignore
export function serializeRegistryPostResponse(writer, registryPostResponse = {}, isSerializingDerivedType = false) {
    if (!registryPostResponse || isSerializingDerivedType) {
        return;
    }
