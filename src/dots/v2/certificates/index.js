 ...
 */
// @ts-ignore
export function serializeCertificatesGetResponse(writer, certificatesGetResponse = {}, isSerializingDerivedType = false) {
    if (!certificatesGetResponse || isSerializingDerivedType) {
        return;
    }
 ...
 */
// @ts-ignore
export function serializeCertificatesPostRequestBody(writer, certificatesPostRequestBody = {}, isSerializingDerivedType = false) {
 ...
 */
// @ts-ignore
export function serializeCertificatesPostResponse(writer, certificatesPostResponse = {}, isSerializingDerivedType = false) {
    if (!certificatesPostResponse || isSerializingDerivedType) {
        return;
    }
