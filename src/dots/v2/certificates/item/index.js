 ...
 */
// @ts-ignore
export function serializeWithCertificate_GetResponse(writer, withCertificate_GetResponse = {}, isSerializingDerivedType = false) {
    if (!withCertificate_GetResponse || isSerializingDerivedType) {
        return;
    }
