 ...
 */
// @ts-ignore
export function serializeWithInvoice_uuGetResponse(writer, withInvoice_uuGetResponse = {}, isSerializingDerivedType = false) {
    if (!withInvoice_uuGetResponse || isSerializingDerivedType) {
        return;
    }
