 ...
 */
// @ts-ignore
export function serializeWithSink_uuGetResponse(writer, withSink_uuGetResponse = {}, isSerializingDerivedType = false) {
    if (!withSink_uuGetResponse || isSerializingDerivedType) {
        return;
    }
