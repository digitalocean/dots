 ...
 */
// @ts-ignore
export function serializeSinksGetResponse(writer, sinksGetResponse = {}, isSerializingDerivedType = false) {
    if (!sinksGetResponse || isSerializingDerivedType) {
        return;
    }
 ...
 */
// @ts-ignore
export function serializeSinksPostRequestBody(writer, sinksPostRequestBody = {}, isSerializingDerivedType = false) {
    if (!sinksPostRequestBody || isSerializingDerivedType) {
        return;
    }
