 ...
 */
// @ts-ignore
export function serializeWithDestination_uuGetResponse(writer, withDestination_uuGetResponse = {}, isSerializingDerivedType = false) {
    if (!withDestination_uuGetResponse || isSerializingDerivedType) {
        return;
    }
