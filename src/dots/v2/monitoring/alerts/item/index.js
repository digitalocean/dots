 ...
 */
// @ts-ignore
export function serializeWithAlert_uuGetResponse(writer, withAlert_uuGetResponse = {}, isSerializingDerivedType = false) {
    if (!withAlert_uuGetResponse || isSerializingDerivedType) {
        return;
    }
 ...
 */
// @ts-ignore
export function serializeWithAlert_uuPutResponse(writer, withAlert_uuPutResponse = {}, isSerializingDerivedType = false) {
    if (!withAlert_uuPutResponse || isSerializingDerivedType) {
        return;
    }
