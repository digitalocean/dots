 ...
 */
// @ts-ignore
export function serializeAlertsGetResponse(writer, alertsGetResponse = {}, isSerializingDerivedType = false) {
    if (!alertsGetResponse || isSerializingDerivedType) {
        return;
    }
 ...
 */
// @ts-ignore
export function serializeAlertsPostResponse(writer, alertsPostResponse = {}, isSerializingDerivedType = false) {
    if (!alertsPostResponse || isSerializingDerivedType) {
        return;
    }
