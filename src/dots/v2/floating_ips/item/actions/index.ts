 ...
 */
// @ts-ignore
export function serializeActionsPostRequestBody(writer: SerializationWriter, actionsPostRequestBody: Partial<Floating_ip_action_assign | Floating_ip_action_unassign> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
