export class KiotaHelper {
    static traverseAndFlatten(obj: any): any {
        if (Array.isArray(obj)) {
            return obj.map((item: any) => KiotaHelper.traverseAndFlatten(item));
    ...
    static unwrapKiota(obj: any): any {
        if (Array.isArray(obj)) {
    ...
    static flattenAndUnwrap(obj: any): any {
